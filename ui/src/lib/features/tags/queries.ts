 ...
 * so we update the frontend cache directly.
 */
function updateTopologyEntityTags(
	...
	const field = { Host: 'hosts', Service: 'services', Subnet: 'subnets' }[entityType] as
		| 'hosts'
		| 'services'
		| 'subnets'
		| undefined;
