...
impl GraphBuilder {
    ...
    fn determine_subnet_child_header_text(
        ...
        // P1: Docker containers always get "Docker @" headers — check before VM
        // so that containers running on VMs don't get "VM:" headers
        ...
        // P2: Show virtualization provider for non-Docker elements
